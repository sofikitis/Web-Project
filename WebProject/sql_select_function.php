<?php
	...
	sql_select_js("*", "square_points", "1", $servername, $username, $password, $dbname);
	
	function sql_select_js($columns, $table_name, $condition, $servername, $username, $password, $dbname){
		// Create connection
		...
		//$sql = "SELECT * FROM city_square ORDER BY square_ID";
